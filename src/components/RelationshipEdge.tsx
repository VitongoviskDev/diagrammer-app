...
export function RelationshipEdge({
  ...
  return (
    <>
      ...
      />
      {/* With the badge switched off the whole card goes, not just the
          cardinality — but it comes back on the selected edge, so removing a
          relationship straight from the board stays reachable. */}
      {(showCardinality || selected) && (
        <EdgeLabelRenderer>
          <div
